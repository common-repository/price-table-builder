...
Tags: Price Table Builder, Price Table, pricing table, comparison table, pricing plan,
...
Price table builder is a beautiful plugin for WordPress. Use multiple options to showcase your pricing table.
...
* [Wordpress](https://huge-it.com/wordpress-price-table-builder/)
* [Demo](https://huge-it.com/wordpress-price-table-builder-demo-1/)
* [FAQ](https://huge-it.com/wordpress-price-table-builder-faq/)
* [User Manual](https://huge-it.com/wordpress-price-table-builder-user-manual/)
* [Support](https://huge-it.com/contact-us/)
* [Github Project](https://github.com/Huge-IT/price-table-builder)


Represent an incredibly important aspect to your business. If you need a tool to create the price list using the best designed tables and add the tables on WordPress, then you should look at this Price Table Builder plugin for WordPress from Huge-IT.
...
The basic version is free, that allows you to create, manage and embed the tables in your page/post using a shortcode. Free version also provides ability to customize the color of every field and text in the list as well as use some HTML tags to add links.
...
1.  [View](https://huge-it.com/wordpress-price-table-builder-demo-1/#plugin_demo_wrapper)
2.  [View](https://huge-it.com/wordpress-price-table-builder-demo-2/#plugin_demo_wrapper)
3.  [View](https://huge-it.com/wordpress-price-table-builder-demo-3/#plugin_demo_wrapper)
4.  [Admin page](https://huge-it.com/wordpress-price-table-builder/) - Admin page
...
= Is the Pro version a one time or per year/month payment? =
...
* 2.1 After installation the plugin has section, from where you may Add New Table 
...
Use the very FIRST plan to make general changes on all plans, such as delete feature fields, hide text, or hide buttons. Also use very the first columns to create horizontal list of the products.
...
* text Color. Specifies the color on the tag text
...
* This is the competitive new plugin for WordPress.